...
<html lang="en">
  <head>
    ...
    <!-- NProgress -->
    <link href="../assets/css/vendors/nprogress/nprogress.css" rel="stylesheet">
    <!-- Animate.css -->
    <link href="../assets/css/vendors/animate.css/animate.min.css" rel="stylesheet">
          ...
          <section class="login_content">
            <form method="post" action="check">
              ...
              <div class="separator">
                ...
                <div>
                  <h1><i class="fa fa-medkit"></i> Hi.Klinik</h1>
