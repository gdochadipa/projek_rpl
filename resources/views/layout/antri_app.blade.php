  ...
  <html lang="en">
    ...
    <div class="menu_section active">
                              ...
                              <ul class="nav side-menu" style="">
                                <li class=""><a href="../main"><i class="fa fa-home"></i> Dashboard</a>

                                </li>
                                <li class=""><a href="../booking"><i class="fa fa-home"></i> Booking Antrian</a>

                                </li>
                                <li><a href="../riwayat"><i class="fa fa-desktop"></i> Riwayat Antrian</a>
